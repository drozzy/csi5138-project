...
class TransformerEncoderClassifier(tf.keras.Model):
    ...
    """
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size, pe_input, rate=0.1, use_positional_encoding=True):
        super().__init__()

        self.encoder = Encoder(num_layers, d_model, num_heads, dff, 
                               input_vocab_size, pe_input, rate, use_positional_encoding=use_positional_encoding)
